...
class Game:
    def __init__(self):
        # 玩家1: WASD控制
        self.snake1 = Snake((10, 10), GREEN, 
                          (pygame.K_w, pygame.K_s, pygame.K_a, pygame.K_d))
        # 玩家2: 小键盘控制(8-上, 5-下, 4-左, 6-右)
        self.snake2 = Snake((30, 10), PURPLE, 
    ...
    def draw(self, surface):
        ...
        if self.paused:
            ...
            paused_text = self.big_font.render("游戏暂停", True, WHITE)
            continue_text = self.font.render("按ESC键继续游戏", True, WHITE)
            
            surface.blit(paused_text, (WIDTH//2 - paused_text.get_width()//2, HEIGHT//2 - 30))
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    if game.game_over:
                        ...
                        game.paused = not game.paused  # 切换暂停状态
                elif event.key == pygame.K_r and (game.game_over or game.paused):
                    game.reset()
